    ...
    groups: [
      {
        ...
        items: [
          { label: "Tops", value: "womens-tops" },
          { label: "Breeches", value: "breeches" },
          { label: "Jodhpurs", value: "jodhpurs" },
          { label: "Riding Tights", value: "riding-tights" },
          { label: "Jeans & Pants", value: "womens-jeans-pants" },
          { label: "Competition Shirts", value: "womens-competition-shirts" },
          { label: "Competition Jackets", value: "womens-competition-jackets" },
        ],
      },
      {
        ...
        value: "mens-clothing",
        items: [
          { label: "Tops", value: "mens-tops" },
          { label: "Jeans & Pants", value: "mens-jeans-pants" },
          { label: "Competition Shirts", value: "mens-competition-shirts" },
          { label: "Competition Jackets", value: "mens-competition-jackets" },
        ],
      },
      {
        ...
        items: [
          { label: "Tall Boots", value: "womens-tall-boots" },
          { label: "Paddock Boots", value: "womens-paddock-boots" },
          { label: "Chaps", value: "womens-chaps" },
          { label: "Western Boots", value: "womens-western-boots" },
          { label: "Everyday Footwear", value: "womens-everyday-footwear" },
        ],
      },
      {
        ...
        value: "mens-footwear",
        items: [
          { label: "Tall Boots", value: "mens-tall-boots" },
          { label: "Paddock Boots", value: "mens-paddock-boots" },
          { label: "Chaps", value: "mens-chaps" },
          { label: "Western Boots", value: "mens-western-boots" },
          { label: "Everyday Footwear", value: "mens-everyday-footwear" },
        ],
      },
      {
