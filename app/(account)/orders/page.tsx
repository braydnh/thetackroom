...
export default async function OrdersPage() {
  ...
  // Fetch orders where this user is buyer OR seller
  ...
  // Fetch listing info for each order
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {isSeller && (
                      <span className="rounded-full px-2 py-0.5 text-[10px] font-medium bg-olive/10 text-olive">
                        Selling
                      </span>
                    )}
                  </div>
                  <div className="flex items-center gap-3 mt-1 text-xs text-muted-foreground">
                    ...
                    <span className="capitalize">{order.pickup_method === "local_pickup" ? "Local pickup" : "Shipping"}</span>
